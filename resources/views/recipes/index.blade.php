...
<div class="container mx-auto px-4 py-8">
    <h1 class="text-3xl font-bold mb-6">Popular Recipes</h1>
    ...
    <form action="{{ route('recipes.search') }}" method="GET" class="mb-6">
        ...
        <small class="text-gray-500 mt-1">Example: Pizza, Spaghetti, Salad</small>
    </form>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        @empty
            <div class="col-span-full bg-yellow-100 border border-yellow-400 text-yellow-700 px-4 py-3 rounded relative" role="alert">
                ...
                <span class="block sm:inline">No recipes available at the moment.</span>
            </div>
        @endforelse
    </div>
</div>
