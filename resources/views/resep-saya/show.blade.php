    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
            <div class="grid md:grid-cols-2 gap-6">
                ...
                <!-- Informasi Resep -->
                <div>
                    <h1 class="text-3xl font-bold mb-4">{{ $resep->nama_makanan }}</h1>
                    ...
                    <div class="grid grid-cols-3 gap-4 mb-6 text-center">
                        <div class="bg-blue-50 p-3 rounded-lg">
                            ...
                            <span class="text-gray-900">
                                {{ $resep->waktu_memasak ?? 'N/A' }} minutes
                            </span>
                        </div>
                        <div class="bg-green-50 p-3 rounded-lg">
                            ...
                            <strong class="block text-gray-700 mb-1">Portion</strong>
                            <span class="text-gray-900">
                                {{ $resep->porsi ?? 'N/A' }} person
                            </span>
                        </div>
                    ...
                    <div class="flex space-x-4 mb-4">
                        <a 
                            href="{{ route('resep-saya.edit', $resep->id) }}" 
                            class="flex-1 bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600 text-center">Edit Recipe</a>
                        <form 
                            action="{{ route('resep-saya.destroy', $resep->id) }}" 
                            method="POST" 
                            class="flex-1"
                        >
                            @csrf
